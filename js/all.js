...
var cacheImg = [
	...
	'images/fauxBG3.png',
	'images/fauxBG4.png',
	'images/welcomeRing1G.png',
    'images/welcomeRing2G.png',
    'images/welcomeRing3G.png'
];
...
function bindButtons(){
    ...
    $(".popup div").unbind('click').bind('click',function(e){
        hidePopup();
    })
...
function startVoiceRecog(){
	...
	recognition.onresult = function(event) {
		for (var i = event.resultIndex; i < event.results.length; ++i) {
            ...
            $(".tts").html(resultStr);
			if(resultStr.toLowerCase().search("jarvis")!=-1 && recogJarvis == 0){
				recogJarvis = 1;
				talkBack("Welcome");
			}	
			if(resultStr.toLowerCase().search("application")!=-1 && recogJarvis == 1 && recogApplication == 0){
				recogApplication = 1;
				//unlockApp();
